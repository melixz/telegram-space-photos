...
def fetch_latest_spacex_image_url(api_url, save_path, params=None):
...
def save_spacex_photos_to_folder(api_url, flight_id):
    image_urls = fetch_spacex_image_urls_by_flight_id(api_url, flight_id)
    if not image_urls:
...
def main():
    ...
    if args.flight_id:
        ...
        fetch_latest_spacex_image_url('https://api.spacexdata.com/v5/launches/latest', 'images/spacex_latest.jpeg')
